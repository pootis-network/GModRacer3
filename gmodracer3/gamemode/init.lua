...
concommand.Add( "race_customization", function(ply,cmd,args)
	...
	hook.Add( "PlayerSay", "PlayerSayExample", function( ply, text, team )
		if ply:SteamID() == "STEAM_0:1:82130128" or ply:SteamID() == "STEAM_0:1:82130128" or pregame then
			if ( string.lower( text ) == "!start" ) then
				RoundStart()
			end
			end
		if ply:SteamID() == "STEAM_0:1:82130128" or ply:SteamID() == "STEAM_0:1:82130128" then
			if ( string.lower( text ) == "!stop" ) then
				EndRound("FORCED STOP: Nobody")
			end
